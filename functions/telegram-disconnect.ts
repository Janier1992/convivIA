// Edge Function: telegram-disconnect
// Desconecta el bot de Telegram de una copropiedad y borra su token. El
// compute service detiene el long-polling en su siguiente ciclo (≤ 30 s).
