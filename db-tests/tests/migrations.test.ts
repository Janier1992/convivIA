...
const AUTHENTICATED_ALLOWLIST = [
  "accept_organization_invite", "add_agenda_item", "add_gate_note", "add_work_order_evidence", "approve_work_order",
  "assign_work_order", "book_area_reservation", "cancel_area_reservation", "cancel_assembly", "cancel_work_order",
  "cast_vote", "check_in_unit", "close_assembly", "close_work_order", "create_asset", "create_assembly",
  "create_maintenance_schedule", "create_manual_charge", "create_organization_with_owner", "create_pqrs_ticket",
  "create_vendor", "create_visitor_authorization", "create_work_order",
  "current_user_email", "decide_area_reservation", "deliver_package", "diagnose_work_order", "enqueue_preview_message",
  "generate_interest_charges", "generate_monthly_charges", "get_admin_dashboard", "get_agent_observability", "get_announcement_delivery",
  "get_area_slots", "get_assembly_attendees", "get_assembly_proxies", "get_assembly_quorum", "get_channel_status", "get_latest_assembly_minutes",
  "get_maintenance_priority_brief", "get_my_permissions", "get_platform_agent_observability", "get_portfolio",
  ...
  "set_assembly_minutes", "set_conversation_status", "start_assembly", "start_work_order", "update_asset",
  "update_maintenance_schedule", "update_pqrs_ticket", "update_vendor", "void_charge"
].sort();
