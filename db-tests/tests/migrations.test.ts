...
const AUTHENTICATED_ALLOWLIST = [
  ...
  "get_area_slots", "get_assembly_attendees", "get_assembly_proxies", "get_assembly_quorum", "get_channel_status", "get_my_permissions", "get_platform_agent_observability", "get_portfolio",
